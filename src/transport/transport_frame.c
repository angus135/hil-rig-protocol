...
static HIL_Transport_Status_T HIL_TRANSPORT_COBS_Encode( const uint8_t* raw_frame,
                                                         size_t raw_frame_len, uint8_t* out_buffer,
                                                         size_t  out_buffer_len,
                                                         size_t* bytes_written );

static HIL_Transport_Status_T HIL_TRANSPORT_COBS_Decode( const uint8_t* encoded_frame,
                                                         ...
                                                         size_t* bytes_written )
{
    ...
    if ( ( ( raw_frame == ( const uint8_t* )0 ) && ( raw_frame_len > 0u ) )
         || ( out_buffer == ( uint8_t* )0 ) || ( bytes_written == ( size_t* )0 ) )
    {
                                                         ...
                                                         size_t* bytes_written )
{
    ...
    if ( ( encoded_frame == ( const uint8_t* )0 ) || ( out_buffer == ( uint8_t* )0 )
                                                   ...
                                                   size_t* bytes_written )
{
    ...
    if ( ( frame == ( const HIL_Transport_Frame_T* )0 ) || ( out_buffer == ( uint8_t* )0 )
         || ( bytes_written == ( size_t* )0 ) )
    {
        return HIL_TRANSPORT_STATUS_INVALID_ARGUMENT;
    }
     ...
     */
    return HIL_TRANSPORT_COBS_Encode( frame->payload, frame->payload_len, out_buffer,
                                      out_buffer_len, bytes_written );
}
                            ...
                            size_t payload_buffer_len, size_t* payload_bytes_written )
{
    ...
    if ( ( encoded_frame == ( const uint8_t* )0 ) || ( out_frame == ( HIL_Transport_Frame_T* )0 )
    ...
    return HIL_TRANSPORT_COBS_Decode( encoded_frame, encoded_frame_len, &raw_frame_placeholder,
                                      sizeof( raw_frame_placeholder ), &raw_bytes_written );
}

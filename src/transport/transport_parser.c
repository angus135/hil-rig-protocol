...
{
    if ( ( parser == ( HIL_Transport_Parser_T* )0 ) || ( scratch_buffer == ( uint8_t* )0 )
...
HIL_Transport_Parse_Result_T HIL_TRANSPORT_Parser_Push_Byte( HIL_Transport_Parser_T* parser,
                                                             uint8_t                 byte )
{
    if ( ( parser == ( HIL_Transport_Parser_T* )0 ) || ( parser->scratch_buffer == ( uint8_t* )0 )
                                                              ...
                                                              size_t* bytes_consumed )
{
    ...
    if ( ( parser == ( HIL_Transport_Parser_T* )0 ) || ( data == ( const uint8_t* )0 )
                                                        ...
                                                        size_t* payload_bytes_written )
{
    ...
    if ( ( parser == ( HIL_Transport_Parser_T* )0 ) || ( out_frame == ( HIL_Transport_Frame_T* )0 )
    ...
    status =
        HIL_TRANSPORT_Decode_Frame( parser->scratch_buffer, parser->bytes_used, out_frame,
                                    payload_buffer, payload_buffer_len, payload_bytes_written );

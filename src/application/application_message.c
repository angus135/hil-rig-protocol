                                 ...
                                 HIL_Application_Context_T* new_contex, uint8_t* encoded_message )
{
    ...
    // Message Type
    memcpy( &( new_context->type ), encoded_message[sizeof( message->test_id )],
            sizeof( new_context->type ) );
    // Message sub-Type
    memcpy( &( new_context->sub_type ),
            encoded_message[sizeof( message->test_id ) + sizeof( context->type )],

...
#define HIL_APPLICATION_TEST_CONFIG_CAN_RECORD_SIZE 13u
...
_Static_assert( HIL_APPLICATION_TEST_CONFIG_SPI_OFFSET == 116u, "Test Configuration SPI offset" );
_Static_assert( HIL_APPLICATION_TEST_CONFIG_UART_OFFSET == 144u, "Test Configuration UART offset" );
_Static_assert( HIL_APPLICATION_TEST_CONFIG_I2C_OFFSET == 174u, "Test Configuration I2C offset" );
_Static_assert( HIL_APPLICATION_TEST_CONFIG_EXTENSION_LENGTH_OFFSET == 202u,
                "Test Configuration extension length offset" );
_Static_assert( HIL_APPLICATION_TEST_CONFIG_FIXED_PAYLOAD_SIZE == 203u,

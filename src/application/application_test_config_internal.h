...
#define HIL_APPLICATION_TEST_CONFIG_CAN_RECORD_SIZE 9u
#define HIL_APPLICATION_TEST_CONFIG_SPI_RECORD_SIZE 10u
#define HIL_APPLICATION_TEST_CONFIG_UART_RECORD_SIZE 11u
#define HIL_APPLICATION_TEST_CONFIG_I2C_RECORD_SIZE 10u
...
_Static_assert( HIL_APPLICATION_TEST_CONFIG_SPI_OFFSET == 108u, "Test Configuration SPI offset" );
_Static_assert( HIL_APPLICATION_TEST_CONFIG_UART_OFFSET == 128u, "Test Configuration UART offset" );
_Static_assert( HIL_APPLICATION_TEST_CONFIG_I2C_OFFSET == 150u, "Test Configuration I2C offset" );
_Static_assert( HIL_APPLICATION_TEST_CONFIG_EXTENSION_LENGTH_OFFSET == 170u,
                "Test Configuration extension length offset" );
_Static_assert( HIL_APPLICATION_TEST_CONFIG_FIXED_PAYLOAD_SIZE == 171u,

...
#define HIL_APPLICATION_ABSOLUTE_MAX_MESSAGE_SIZE ( 10000u )
...
#define HIL_APPLICATION_HEADER_PAYLOAD_SIZE_BYTES math.ceil(math.log2(HIL_APPLICATION_ABSOLUTE_MAX_MESSAGE_SIZE))
#define HIL_APPLICATION_HEADER_SIZE_BYTES (HIL_APPLICATION_TEST_ID_SIZE+HIL_APPLICATION_MESSAGE_TYPE_SIZE_BYTES+HIL_APPLICATION_MESSAGE_SUB_TYPE_SIZE_BYTES)

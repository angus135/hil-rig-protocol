...
#define HIL_APPLICATION_SYSTEM_INFO_REQUEST_FIXED_ENCODE_SIZE 5U
#define HIL_APPLICATION_SYSTEM_INFO_RESPONSE_FIXED_ENCODE_SIZE 10U
#define HIL_APPLICATION_CHANNEL_ID_ENCODE_SIZE 6U

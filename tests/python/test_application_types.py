...
ENUMS = {
    ...
    p.ResponseScope: (
        ...
        {
            "INVALID": "HIL_APPLICATION_RESPONSE_SCOPE_INVALID",
            "TEST_CONFIGURATION": "HIL_APPLICATION_RESPONSE_SCOPE_TEST_CONFIGURATION",
            "TICK": "HIL_APPLICATION_RESPONSE_SCOPE_TICK",
            "COMPLETE_TEST": "HIL_APPLICATION_RESPONSE_SCOPE_COMPLETE_TEST",
            "EXECUTION_CONTROL": "HIL_APPLICATION_RESPONSE_SCOPE_EXECUTION_CONTROL",
            "GLOBAL_CONTROL": "HIL_APPLICATION_RESPONSE_SCOPE_GLOBAL_CONTROL",
            "RESERVED": "HIL_APPLICATION_RESPONSE_SCOPE_RESERVED",
        },
    ),
    p.ResponseOutcome: (
        "HIL_Application_Response_Outcome_T",
        {
            "INVALID": "HIL_APPLICATION_RESPONSE_OUTCOME_INVALID",
            "ACCEPTED": "HIL_APPLICATION_RESPONSE_OUTCOME_ACCEPTED",
            "REJECTED": "HIL_APPLICATION_RESPONSE_OUTCOME_REJECTED",
            "COMPLETED": "HIL_APPLICATION_RESPONSE_OUTCOME_COMPLETED",
            "FAILED": "HIL_APPLICATION_RESPONSE_OUTCOME_FAILED",
            "RESERVED": "HIL_APPLICATION_RESPONSE_OUTCOME_RESERVED",
        },
    ),
    p.ResponseReason: (
        "HIL_Application_Response_Reason_T",
        {
            "NONE": "HIL_APPLICATION_RESPONSE_REASON_NONE",
            "UNSUPPORTED": "HIL_APPLICATION_RESPONSE_REASON_UNSUPPORTED",
            "OPERATION_NOT_ALLOWED": "HIL_APPLICATION_RESPONSE_REASON_OPERATION_NOT_ALLOWED",
            "INCONSISTENT_TEST_ID": "HIL_APPLICATION_RESPONSE_REASON_INCONSISTENT_TEST_ID",
            "INVALID_TICK": "HIL_APPLICATION_RESPONSE_REASON_INVALID_TICK",
            "LENGTH_MISMATCH": "HIL_APPLICATION_RESPONSE_REASON_LENGTH_MISMATCH",
            "STORAGE_UNAVAILABLE": "HIL_APPLICATION_RESPONSE_REASON_STORAGE_UNAVAILABLE",
            "VALIDATION_FAILED": "HIL_APPLICATION_RESPONSE_REASON_VALIDATION_FAILED",
            "HARDWARE_NOT_READY": "HIL_APPLICATION_RESPONSE_REASON_HARDWARE_NOT_READY",
            "INTERNAL_FAILURE": "HIL_APPLICATION_RESPONSE_REASON_INTERNAL_FAILURE",
            "RESERVED": "HIL_APPLICATION_RESPONSE_REASON_RESERVED",
        },
    ),
    p.ErrorCategory: (
        "HIL_Application_Error_Category_T",
        {
            "INVALID": "HIL_APPLICATION_ERROR_CATEGORY_INVALID",
            "HARDWARE": "HIL_APPLICATION_ERROR_CATEGORY_HARDWARE",
            "EXECUTION": "HIL_APPLICATION_ERROR_CATEGORY_EXECUTION",
            "TIMEOUT": "HIL_APPLICATION_ERROR_CATEGORY_TIMEOUT",
            "RETAINED_DATA": "HIL_APPLICATION_ERROR_CATEGORY_RETAINED_DATA",
            "PROTOCOL": "HIL_APPLICATION_ERROR_CATEGORY_PROTOCOL",
            "INTERNAL": "HIL_APPLICATION_ERROR_CATEGORY_INTERNAL",
            "RESERVED": "HIL_APPLICATION_ERROR_CATEGORY_RESERVED",
        },
    ),
    p.PeripheralVoltage: (
